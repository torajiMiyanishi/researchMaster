...
public final class RoleOfFather extends TRole {
    ...
    public RoleOfFather(TAgent owner, TSpot home, TSpot company) {
        ...
        super(RoleName.Father, owner, 2, 0);
        ...
        new RuleOfMoveFromHomeToCompany(RULE_NAME_OF_MOVE_FROM_HOME_TO_COMPANY, this)
                .setTimeAndStage(9, 0, 0, Stage.AgentMoving);

        // 会社から自宅に移動するルール．17:00:00/エージェント移動ステージに定時実行ルールとして予約する．
        new RuleOfMoveFromCompanyToHome(RULE_NAME_OF_MOVE_FROM_COMPANY_TO_HOME, this)
                .setTimeAndStage(17, 0, 0, Stage.AgentMoving);
    }
